...
class Player {
    constructor(htmlScore, name, sign) {
        this.score = 0;
        this.myBoxes = [];
...
let turnOf; //esta variable nos ayudara a determinar de quien es el turno
...
function activateWinnerScreen(player) {
...
function winCheck(turnOf) {
    function checking(box1, box2, box3) {
        if (turnOf.myBoxes.includes(box1) &&
